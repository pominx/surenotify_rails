require 'spec_helper'
require 'surenotify_rails/attachment'

describe SurenotifyRails::Attachment do
  describe "#send_message" do
    ...
    it 'should respond to rest_client api' do
      attachment = SurenotifyRails::Attachment.new(@mail.attachments.first)
    ...
    it 'should set cid as original_filename' do
      attachment = SurenotifyRails::Attachment.new(@mail.attachments.inline.first, inline: true)
    ...
    it 'should set filename as original_filename for hash' do
      attachment = SurenotifyRails::Attachment.new(@mail.attachments.last)
